...
from eurovat.cache import Cache
...
class VatRuleRegistry:
    ...
    def get_vat_rate(
        self, to_country, cn_code=None, date: Optional[datetime.datetime] = None
    ):
    ...
    def fetch(self, countries: Union[Sequence[Union[str, EUState]], None]=None):
        if countries is None:
            final_countries: Sequence[Union[str, EUState]] = states
        else:
